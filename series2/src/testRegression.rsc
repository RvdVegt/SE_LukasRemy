...
bool testCase1() {
	...
	tuple[int, int] results = testing(|project://smallsql0.21_src/src|);
...
bool testCase2() {
	tuple[int, int] results = testing(|project://temp/src/temp/car.java|);
...
bool testCase4() {
	tuple[int, int] results = testing(|project://temp/src/temp|);
